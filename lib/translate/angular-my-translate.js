...
angular.module('myTranslate', ['ng']).run([
  '$translate',
  function ($translate) {
...
angular.module('myTranslate').provider('$translate', [
  '$STORAGE_KEY',
...
angular.module('myTranslate').factory('$translateDefaultInterpolation', [
  '$interpolate',
...
angular.module('myTranslate').constant('$STORAGE_KEY', 'NG_TRANSLATE_LANG_KEY');
angular.module('myTranslate').directive('translate', [
  '$translate',
  '$q',
  '$interpolate',
  '$compile',
...
angular.module('myTranslate').directive('translateCloak', [
  '$rootScope',
  '$translate',
...
angular.module('myTranslate').filter('i18n', [
  '$parse',
  '$translate',
...
angular.module('myTranslate').factory('$translateStaticFilesLoader', [
  '$q',
  '$http',
  function ($q, $http) {
